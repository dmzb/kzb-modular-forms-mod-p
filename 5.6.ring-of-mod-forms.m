// This code verifies some claims made in Example 5.6: the ring of modular forms of level 7 in char 0 and char 3
...
// Log canonical ring of X_0(7) in tame characteristics (e.g. char p = 5)
p := 5;
g := 0; // genus of X is 0
delta := 2; // X has 2 cusps
B := 3*p; // degree bound from KZB
F := GF(p); // may need to search over extensions of GF(p)
sig := [2/3, 2/3]; // signature of X as a stacky curve, from stacky structure code above
...
// Log canonical ring of X_0(7) in characteristic 3
p := 3;
g := 0; // genus of X is 0
delta := 2; // X has 2 cusps
